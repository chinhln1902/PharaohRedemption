...
EnemyController.prototype.level1 = function(){
    ...
    var snake = new Snake(this.gameEngine, AM, 30.5*70, 8*70, 1);
    var snake1 = new Snake(this.gameEngine, AM, 65.5*70, 5.9*70, 1);
    var snake2 = new Snake(this.gameEngine, AM, 68.5*70, 3.9*70, 1);
    var snake3 = new Snake(this.gameEngine, AM, 71.8*70, 1.9*70, 1);
...
EnemyController.prototype.level2 = function() {
    ...
    var snake = new Snake(this.gameEngine, AM, 31.7*70, .9*70, 2);
...
var bat = new Bat(this.gameEngine, AM, 14*70, 3*70);
 ...
 var snake = new Snake(this.gameEngine, AM, 10*70, 7.95*70, 3);
 var snake2 = new Snake(this.gameEngine, AM, 17*70, 7.95*70, 3); 
 var warrior = new Snake(this.gameEngine, AM, 20.6*70, 5.9*70, 3);
 var warrior2 = new Snake(this.gameEngine, AM, 28.7*70, 5.85*70, 3);
 var archer = new Archer(this.gameEngine, AM, 29.3*70, 2.85*70); 
 var warrior3 = new Snake(this.gameEngine, AM, 29.5*70, 1.9*70, 3);
 ...
 var snake8 = new Snake(this.gameEngine, AM, 56*70, 4.85*70, 3);
 ...
 var snake4 = new Snake(this.gameEngine, AM, 33*70, 7.95*70, 3);
 var snake5 = new Snake(this.gameEngine, AM, 38*70, 7.95*70, 3);
 var snake6 = new Snake(this.gameEngine, AM, 42*70, 7.95*70, 3);
